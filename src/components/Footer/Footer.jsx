      ...
      <div className={styles.info}>
        <Row xs={1} md={2} lg={4}>
          <Col xs={12} sm={6} lg={3}>
            ...
            <p>
              View Stockholm is a digital city guide that brings you the best of
              the city.
            </p>
          ...
          <Col xs={12} sm={6} lg={3}>
            ...
            <Nav.Link href="#">Miss a place on our top </Nav.Link>
          ...
          <Col xs={12} sm={6} lg={3}>
            ...
            <Nav.Link href="#">Native</Nav.Link>
          </Col>
        </Row>
        <hr className={styles.hr} />
        <p className={styles.center}>
          © 2023 View Stockholm • All rights reserved • Made with{" "}
          <span className={styles.red}> ♥ </span> for Stockholm
        </p>
      </div>
    </div>
  );
