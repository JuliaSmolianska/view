...
const titles = {
  en: [
    "Stockholm is a beautiful urban city surrounded by water and nature. So many fantastic experiences are waiting for you.",
    "Stockholm Numbers",
    "Year Founded",
    "Inhabitants",
    "Green areas",
  ...
  se: [
    "Stockholm är en vacker urban stad omgiven av vatten och natur. En lång rad fantastiska upplevelser väntar på dig.",
    "Stockholm i siffror",
    "År grundat",
    "Invänare",
    "Gröna ytor",
              ...
              <Row xs={2}>
                <Col xs={6} className={styles.nopadding}>
                  ...
                  <p className={styles.text3}>
                    {titles[languageContext.language][2]}
                  </p>
                </Col>
                <Col xs={6} className={styles.nopadding}>
                  <p className={styles.number}>935619</p>
                  <p className={styles.text3}>
                    {titles[languageContext.language][3]}
                  </p>
                </Col>
              </Row>
              <Row xs={2}>
